...
TEST_F(BlockInfoTest, DoesNotCrashOnZeroPieceSize)
{
...
TEST_F(BlockInfoTest, FinalPieceHasRemainder)
{
...
TEST_F(BlockInfoTest, FinalPiecePerfectFit)
{
...
TEST_F(BlockInfoTest, fieldsAreSet)
{
    ...
    info.initBlockInfo(TotalSize, PieceSize);
