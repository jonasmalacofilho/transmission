...
struct tr_torrent_metainfo_view
{
    char const* comment;
    char const* creator;
...
struct tr_torrent_metainfo_view* tr_torrentMetainfoGet(struct tr_torrent_metainfo const* tm);

/// Files

struct tr_torrent_metainfo_file_view
{
...
struct tr_torrent_metainfo_file_view tr_torrentMetainfoFile(struct tr_torrent_metainfo const* tm, size_t nth);

/// Trackers

struct tr_torrent_metainfo_tracker_view
{
...
struct tr_torrent_metainfo_tracker_view tr_torrentMetainfoTracker(struct tr_torrent_metainfo const* tm, size_t nth);
